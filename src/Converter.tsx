...
const Converter = () => {
    ...
    switch (metrics as unknown as string) {
        case 'money':
            screen = <MoneyConverter />
            break
        case 'distances':
            screen = <DistanceConverter />
            break
        case 'degrees':
            screen = <Error />
            break
            ...
            >
                ...
                >
                    <Tooltip placement="bottom" title="Convert money">
                        <Radio.Button style={style} value="money">
                            <DollarOutlined />
                        </Radio.Button>
                    </Tooltip>
                    <Tooltip placement="bottom" title="Convert distances">
                        <Radio.Button style={style} value="distances">
                            <ExpandAltOutlined />
                        </Radio.Button>
                    </Tooltip>
                    <Tooltip placement="bottom" title="Convert degrees">
                        <Radio.Button style={style} value="degrees">
                            <CopyrightOutlined />
                        </Radio.Button>
                    </Tooltip>
                    <Tooltip placement="bottom" title="Convert time">
                        <Radio.Button style={style} value="time">
                            <ClockCircleOutlined />
                        </Radio.Button>
                    </Tooltip>
                </Radio.Group>
