...
const style = { margin: '5px', width: '65px', height: '65px', overflow: 'hidden' }
        ...
        <div>
            <Row>
                <Col span={24}>
                    <Button 
                    onDragEnter={(e) => { 
                        dispatch(fixDrop(e.target.children[0].innerHTML))
                    ...
                    size="large"
                    >
                    <span onDrop={() => console.log('hey')} className={plusIsEntered ? 'entered' : 'left'}>
                        +
                    </span>
                    </Button>
                </Col>
            ...
            <Row>
                ...
                <Button 
                    ...
                    size="large"
                    >
                    <span onDrop={() => console.log('hey')} className={minusIsEntered ? 'entered' : 'left'}>
                        -
                    </span>
                    </Button>
                </Col>
            ...
            <Row>
                ...
                <Button 
                    ...
                    size="large"
                    >
                    <span onDrop={() => console.log('hey')} className={divideIsEntered ? 'entered' : 'left'}>
                        /
                    </span>
                    </Button>
                </Col>
            ...
            <Row>
                ...
                <Button 
                    ...
                    size="large"
                    >
                    <span onDrop={() => console.log('hey')} className={multiplyIsEntered ? 'entered' : 'left'}>
                        *
                    </span>
                    </Button>
                </Col>
